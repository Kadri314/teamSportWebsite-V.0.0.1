...
function getClubInfo(){
  var clubName=document.getElementById("selectedClub").value;
  window.location.href="result.php?selectedClub="+clubName+"&getClubInfo=true";
}
function getClubTeam(){
  var clubName=document.getElementById("selectedClub").value;
  window.location.href="result.php?selectedClub="+clubName+"&getClubTeam=true";
}
function getClubCourt(){
  var clubName=document.getElementById("selectedClub").value;
  window.location.href="result.php?selectedClub="+clubName+"&getClubCourt=true";
}

// for players
function getPlayerInfo(){
  var playerName=document.getElementById("selectedPlayer").value;
  window.location.href="result.php?selectedPlayer="+playerName+"&getPlayerInfo=true";
}
function getPlayerAwards(){
  var playerName=document.getElementById("selectedPlayer").value;
  window.location.href="result.php?selectedPlayer="+playerName+"&getPlayerAwards=true";
}
function getPlayerMatchHistory(){
  var playerName=document.getElementById("selectedPlayer").value;
  window.location.href="result.php?selectedPlayer="+playerName+"&getPlayerMatchHistory=true";
}

// for teams
function getTeamPlayer(){
  var playerName=document.getElementById("selectedTeam").value;
  window.location.href="result.php?selectedTeam="+playerName+"&getTeamPlayer=true";
}
function getTeamRecord(){
  var playerName=document.getElementById("selectedTeam").value;
  window.location.href="result.php?selectedTeam="+playerName+"&getTeamRecord=true";
}
function getTeamMatchesHistory(){
  var playerName=document.getElementById("selectedTeam").value;
  window.location.href="result.php?selectedTeam="+playerName+"&getTeamMatchesHistory=true";
}
function getTeamStaff(){
  var playerName=document.getElementById("selectedTeam").value;
  window.location.href="result.php?selectedTeam="+playerName+"&getTeamStaff=true";
}
function getTeamTournamnet(){
  var playerName=document.getElementById("selectedTeam").value;
  window.location.href="result.php?selectedTeam="+playerName+"&getTeamTournamnet=true";
}
